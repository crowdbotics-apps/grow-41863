"""
Django settings for grow_41863 project.
...
WSGI_APPLICATION = 'grow_41863.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "grow_41863 API",
    "DESCRIPTION": "API documentation for grow_41863 App",
    "VERSION": "v1",
}
